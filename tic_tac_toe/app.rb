...
board.print_board
board.request_input
board.game_over(move_five.check_who_won(BoardSquare.check_for_wins)) if BoardSquare.check_for_wins
game.next_player
move_six = BoardSquare.new(game.turn, game.player_turn)
board.change_board(move_six.player, move_six.space_number)
board.print_board
board.request_input
board.game_over(move_six.check_who_won(BoardSquare.check_for_wins)) if BoardSquare.check_for_wins
game.next_player
move_seven = BoardSquare.new(game.turn, game.player_turn)
board.change_board(move_seven.player, move_seven.space_number)
board.print_board
board.request_input
board.game_over(move_seven.check_who_won(BoardSquare.check_for_wins)) if BoardSquare.check_for_wins
game.next_player
move_eight = BoardSquare.new(game.turn, game.player_turn)
board.change_board(move_eight.player, move_eight.space_number)
board.print_board
board.request_input
board.game_over(move_eight.check_who_won(BoardSquare.check_for_wins)) if BoardSquare.check_for_wins
game.next_player
move_nine = BoardSquare.new(game.turn, game.player_turn)
board.change_board(move_nine.player, move_nine.space_number)
board.print_board
board.request_input
board.game_over(move_nine.check_who_won(BoardSquare.check_for_wins)) if BoardSquare.check_for_wins
